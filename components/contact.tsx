		...
		<section id="contact" className="py-12 md:py-16">
			<div className="mx-auto max-w-2xl px-4 md:px-8">
				<div className="bg-white/90 backdrop-blur-2xl border border-neutral-300/30 rounded-2xl shadow-2xl shadow-black/10 px-6 py-8">
					<h2 className="mb-4 text-center text-xl md:text-2xl font-semibold text-black">Contact</h2>
					...
					<div className="flex flex-col items-center justify-center gap-4 md:flex-row">
						...
						<a
							...
							className="inline-flex items-center gap-2 rounded-lg border border-neutral-300/50 px-6 py-3 text-black hover:bg-neutral-100 hover:border-neutral-400/60 transition-all duration-200 shadow-sm hover:shadow-md group"
						>
							<svg className="h-4 w-4 fill-black dark:fill-white transition-colors duration-200" viewBox="0 0 24 24">
